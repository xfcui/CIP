...
def load_ChEMBL_Dock(config):
    ...
    ligand_representations_val, graph_prot_index_val, df_val, poses_affinities_val = \
        SelectData(ligand_representations, graph_prot_index, df_info, poses_affinities, valid_assay)
    ...
    valid_data = ChEMBLDock(ligand_representations_val, prot_graphs, prot_coords,
                            graph_prot_index_val, df_val, valid_assay, config.data.test_2, train_assay_d,
                            config.data.ligcut, config.data.protcut, config.data.intercut,
                            config.data.lig_max_neighbors, config.data.prot_max_neighbors,
                            config.data.inter_min_neighbors, config.data.inter_max_neighbors,
                            config.data.add_chemical_bond_feats, config.data.use_mean_node_features,
                            poses_affinities_val)
